...
return ajax.core.GET.call(null,[cljs.core.str("https://api.github.com/users/"),cljs.core.str(user),cljs.core.str("/repos")].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"handler","handler",-195596612),(function (p1__32460_SHARP_){
...
summary.github.github_card_layout = (function summary$github$github_card_layout(p__32462){
...
var user = cljs.core.get.call(null,map__32465__$1,new cljs.core.Keyword(null,"user","user",1532431356));
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [material_ui.core.Card,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [material_ui.core.CardHeader,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"title","title",636505583),"GitHub",new cljs.core.Keyword(null,"subtitle","subtitle",-1614524363),[cljs.core.str("@"),cljs.core.str(user)].join(''),new cljs.core.Keyword(null,"avatar","avatar",-1607499307),cljs.core.deref.call(null,summary.github.github_user).call(null,"avatar_url")], null)], null),(((cljs.core.deref.call(null,summary.github.github_loading) > (0)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [material_ui.core.CircularProgress,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"class","class",-2030961996),"centred card-loading-icon",new cljs.core.Keyword(null,"mode","mode",654403691),"indeterminate"], null)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [material_ui.core.List,cljs.core.map.call(null,((function (map__32465,map__32465__$1,user){
return (function (p1__32461_SHARP_){
return cljs.core.identity.call(null,cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [material_ui.core.ListItem,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"primaryText","primaryText",229382014),cljs.core.get.call(null,p1__32461_SHARP_,"name"),new cljs.core.Keyword(null,"secondaryText","secondaryText",824460892),cljs.core.get.call(null,p1__32461_SHARP_,"description"),new cljs.core.Keyword(null,"leftAvatar","leftAvatar",431224504),reagent.core.as_element.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [material_ui.core.Avatar,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"icon","icon",1679606541),reagent.core.as_element.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [material_ui.core.FontIcon,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"className","className",-1983287057),"octicon octicon-repo"], null)], null))], null)], null)),new cljs.core.Keyword(null,"onTouchTap","onTouchTap",1973229336),((function (map__32465,map__32465__$1,user){
return (function (){
return summary.github.open_in_new_tab.call(null,cljs.core.get.call(null,p1__32461_SHARP_,"html_url"));
});})(map__32465,map__32465__$1,user))
], null)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),cljs.core.get.call(null,p1__32461_SHARP_,"id")], null)));
});})(map__32465,map__32465__$1,user))
,cljs.core.deref.call(null,summary.github.github_repos))], null)),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [material_ui.core.CardActions,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [material_ui.core.FlatButton,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"label","label",1718410804),"View Profile",new cljs.core.Keyword(null,"linkButton","linkButton",-999060964),true,new cljs.core.Keyword(null,"href","href",-793805698),[cljs.core.str("https://github.com/"),cljs.core.str(user)].join('')], null)], null)], null)], null);
});
summary.github.card = cljs.core.with_meta.call(null,summary.github.github_card_layout,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"component-did-mount","component-did-mount",-1126910518),(function (p1__32467_SHARP_){
var user = new cljs.core.Keyword(null,"user","user",1532431356).cljs$core$IFn$_invoke$arity$1(reagent.core.props.call(null,p1__32467_SHARP_));
