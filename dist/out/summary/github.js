...
return ajax.core.GET.call(null,[cljs.core.str("https://api.github.com/users/"),cljs.core.str(user),cljs.core.str("/repos")].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"handler","handler",-195596612),(function (p1__20559_SHARP_){
...
summary.github.github_card_layout = (function summary$github$github_card_layout(p__20561){
var map__20564 = p__20561;
...
summary.github.card = cljs.core.with_meta.call(null,summary.github.github_card_layout,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"component-did-mount","component-did-mount",-1126910518),(function (p1__20566_SHARP_){
var user = new cljs.core.Keyword(null,"user","user",1532431356).cljs$core$IFn$_invoke$arity$1(reagent.core.props.call(null,p1__20566_SHARP_));
