...
var G__10081 = o;
(G__10081[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
while (G__10083__i < G__10083__a.length) {G__10083__a[G__10083__i] = arguments[G__10083__i + 0]; ++G__10083__i;}
  args = new cljs.core.IndexedSeq(G__10083__a,0,null);
} 
...
if(cljs.core.truth_((function (){var and__4036__auto__ = (!((reagent.impl.template.find_dom_node == null)));
if(and__4036__auto__){
var and__4036__auto____$1 = (!((jsprops == null)));
if(and__4036__auto____$1){
var and__4036__auto____$2 = (jsprops["hasOwnProperty"])("onChange");
...
var G__10087 = jsprops;
(G__10087["defaultValue"] = value);

(G__10087["onChange"] = ((function (G__10087,v,value,on_change){
return (function (p1__10086_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__10086_SHARP_);
});})(G__10087,v,value,on_change))
);
...
var vec__10090 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10090,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10090,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10090,(2),null);
...
var jsprops = ({"argv": v});
var temp__5724__auto___10094 = reagent.impl.template.key_from_vec(v);
if((temp__5724__auto___10094 == null)){
} else {
var key_10095 = temp__5724__auto___10094;
(jsprops["key"] = key_10095);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__10096 = (new reagent.impl.template.NativeWrapper());
(G__10096["name"] = c);
...
var G__10097 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__10097) : reagent.impl.template.as_element.call(null,G__10097));
} else {
...
var len__4641__auto___10102 = arguments.length;
var i__4642__auto___10103 = (0);
while(true){
if((i__4642__auto___10103 < len__4641__auto___10102)){
args__4647__auto__.push((arguments[i__4642__auto___10103]));

var G__10104 = (i__4642__auto___10103 + (1));
i__4642__auto___10103 = G__10104;
continue;
} else {
}
break;
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq10100){
var G__10101 = cljs.core.first(seq10100);
var seq10100__$1 = cljs.core.next(seq10100);
var self__4628__auto__ = this;
return self__4628__auto__.cljs$core$IFn$_invoke$arity$variadic(G__10101,seq10100__$1);
});
...
break;
default:
var G__10107 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null);
v = G__10107;
continue;
...
var n__4518__auto___10109 = a.length;
var i_10110 = (0);
while(true){
if((i_10110 < n__4518__auto___10109)){
(a[i_10110] = reagent.impl.template.as_element((a[i_10110])));
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4518__auto___10112 = a.length;
var i_10113 = (0);
while(true){
if((i_10113 < n__4518__auto___10112)){
var val_10114 = (a[i_10113]);
if(((cljs.core.vector_QMARK_(val_10114)) && ((reagent.impl.template.key_from_vec(val_10114) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_10113] = reagent.impl.template.as_element(val_10114));
...
var ctx = ({});
var vec__10116 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10116,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10116,(1),null);
...
var G__10119 = (cljs.core.count(argv) - first_child);
switch (G__10119) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv(((function (G__10119){
