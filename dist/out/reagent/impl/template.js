...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__16942__auto__,writer__16943__auto__,opt__16944__auto__){
return cljs.core._write.call(null,writer__16943__auto__,"reagent.impl.template/NativeWrapper");
});
...
var or__16344__auto__ = reagent.impl.template.named_QMARK_.call(null,x);
...
var or__16344__auto__ = reagent.impl.template.hiccup_tag_QMARK_.call(null,x);
if(cljs.core.truth_(or__16344__auto__)){
return or__16344__auto__;
} else {
...
var G__25390 = o;
(G__25390[reagent.impl.template.cached_prop_name.call(null,k)] = reagent$impl$template$convert_prop_value.call(null,v));
...
return (function() { 
var G__25391__delegate = function (args){
...
while (G__25392__i < G__25392__a.length) {G__25392__a[G__25392__i] = arguments[G__25392__i + 0]; ++G__25392__i;}
  args = new cljs.core.IndexedSeq(G__25392__a,0);
} 
return G__25391__delegate.call(this,args);};
G__25391.cljs$lang$maxFixedArity = 0;
G__25391.cljs$lang$applyTo = (function (arglist__25393){
var args = cljs.core.seq(arglist__25393);
return G__25391__delegate(args);
});
...
var old_25394 = (p["className"]);
(p["className"] = ((cljs.core.some_QMARK_.call(null,old_25394))?[cljs.core.str(class$),cljs.core.str(" "),cljs.core.str(old_25394)].join(''):class$));
} else {
}
...
if(cljs.core.not.call(null,(function (){var and__16332__auto__ = (node === document.activeElement);
if(and__16332__auto__){
var and__16332__auto____$1 = reagent.impl.template.has_selection_api_QMARK_.call(null,(node["type"]));
...
if(cljs.core.truth_((function (){var and__16332__auto__ = (jsprops["hasOwnProperty"])("onChange");
...
var G__25397 = jsprops;
(G__25397["defaultValue"] = value);

(G__25397["onChange"] = ((function (G__25397,v,value,on_change){
return (function (p1__25395_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__25395_SHARP_);
});})(G__25397,v,value,on_change))
);
...
var vec__25399 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__25399,(0),null);
var id = cljs.core.nth.call(null,vec__25399,(1),null);
var class$ = cljs.core.nth.call(null,vec__25399,(2),null);
...
var temp__4427__auto__ = (function (){var G__25403 = cljs.core.meta.call(null,v);
var G__25403__$1 = (((G__25403 == null))?null:reagent.impl.template.get_key.call(null,G__25403));
return G__25403__$1;
})();
if((temp__4427__auto__ == null)){
...
var jsprops = {"argv": v};
var G__25405_25406 = v;
var G__25405_25407__$1 = (((G__25405_25406 == null))?null:reagent.impl.template.key_from_vec.call(null,G__25405_25406));
var G__25405_25408__$2 = (((G__25405_25407__$1 == null))?null:(jsprops["key"] = G__25405_25407__$1));
...
var p = (function (){var temp__4427__auto__ = (function (){var G__25411 = cljs.core.meta.call(null,argv);
var G__25411__$1 = (((G__25411 == null))?null:reagent.impl.template.get_key.call(null,G__25411));
return G__25411__$1;
})();
if((temp__4427__auto__ == null)){
return jsprops;
...
var G__25412 = (((jsprops == null))?{}:jsprops);
(G__25412["key"] = key);
...
var G__25413 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__25413;
continue;
}
} else {
...
var n__17247__auto___25414 = a.length;
var i_25415 = (0);
while(true){
if((i_25415 < n__17247__auto___25414)){
(a[i_25415] = reagent.impl.template.as_element.call(null,(a[i_25415])));

var G__25416 = (i_25415 + (1));
i_25415 = G__25416;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__17247__auto___25417 = a.length;
var i_25418 = (0);
while(true){
if((i_25418 < n__17247__auto___25417)){
var val_25419 = (a[i_25418]);
if((cljs.core.vector_QMARK_.call(null,val_25419)) && ((reagent.impl.template.key_from_vec.call(null,val_25419) == null))){
(o["no-key"] = true);
} else {
}

(a[i_25418] = reagent.impl.template.as_element.call(null,val_25419));

var G__25420 = (i_25418 + (1));
i_25418 = G__25420;
continue;
} else {
}
...
if(cljs.core.truth_((function (){var and__16332__auto__ = cljs.core.not.call(null,reagent.impl.component._STAR_non_reactive_STAR_);
if(and__16332__auto__){
return (ctx["no-key"]);
} else {
return and__16332__auto__;
...
var G__25422 = (cljs.core.count.call(null,argv) - first_child);
switch (G__25422) {
case (0):
...
break;
default:
return (React["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__25422){
