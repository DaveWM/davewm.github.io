...
app.core.history = pushy.core.pushy.call(null,app.core.set_page_BANG_,(function (p1__21268_SHARP_){
return bidi.bidi.match_route.call(null,app.core.routes,p1__21268_SHARP_);
}));
...
return ajax.core.GET.call(null,app.core.api_url,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"handler","handler",-195596612),(function (p1__21273_SHARP_){
return cljs.core.reset_BANG_.call(null,app.core.data,p1__21273_SHARP_);
