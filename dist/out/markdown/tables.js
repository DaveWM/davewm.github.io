...
return cljs.core.map.call(null,(function (p1__23696_SHARP_){
return cljs.core.identity.call(null,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"text","text",-1790561697),p1__23696_SHARP_], null));
}),cljs.core.map.call(null,clojure.string.trim,(function (p1__23695_SHARP_){
return clojure.string.split.call(null,p1__23695_SHARP_,/\|/);
}).call(null,clojure.string.trim.call(null,(function (p1__23694_SHARP_){
if(cljs.core._EQ_.call(null,cljs.core.first.call(null,p1__23694_SHARP_),"|")){
return cljs.core.apply.call(null,cljs.core.str,cljs.core.rest.call(null,p1__23694_SHARP_));
} else {
return p1__23694_SHARP_;
}
}).call(null,text)))));
});
...
var is_table_divider_QMARK_ = (function (){var and__16346__auto__ = cljs.core._EQ_.call(null,table_divider_re,text);
if(and__16346__auto__){
var and__16346__auto____$1 = cljs.core.get_in.call(null,state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"table","table",-564943036),new cljs.core.Keyword(null,"in-table-body?","in-table-body?",-136773915)], null));
