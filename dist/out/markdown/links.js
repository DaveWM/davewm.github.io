...
var len__17416__auto___22029 = arguments.length;
var i__17417__auto___22030 = (0);
while(true){
if((i__17417__auto___22030 < len__17416__auto___22029)){
args__17423__auto__.push((arguments[i__17417__auto___22030]));

var G__22031 = (i__17417__auto___22030 + (1));
i__17417__auto___22030 = G__22031;
continue;
} else {
}
break;
...
markdown.links.img.cljs$core$IFn$_invoke$arity$variadic = (function (alt,url,state,p__22027){
var vec__22028 = p__22027;
var title = cljs.core.nth.call(null,vec__22028,(0),null);
...
markdown.links.img.cljs$lang$applyTo = (function (seq22023){
...
return markdown.links.img.cljs$core$IFn$_invoke$arity$variadic(G__22024,G__22025,G__22026,seq22023__$3);
});
...
var vec__22036 = cljs.core.split_with.call(null,cljs.core.partial.call(null,cljs.core.not_EQ_,"]"),xs__$1);
var alt = cljs.core.nth.call(null,vec__22036,(0),null);
var xy = cljs.core.nth.call(null,vec__22036,(1),null);
var vec__22037 = cljs.core.split_with.call(null,cljs.core.partial.call(null,cljs.core.not_EQ_,")"),cljs.core.drop.call(null,(2),xy));
var url_title = cljs.core.nth.call(null,vec__22037,(0),null);
var zy = cljs.core.nth.call(null,vec__22037,(1),null);
var vec__22038 = cljs.core.split_with.call(null,cljs.core.partial.call(null,cljs.core.not_EQ_," "),url_title);
var url = cljs.core.nth.call(null,vec__22038,(0),null);
var title = cljs.core.nth.call(null,vec__22038,(1),null);
var vec__22039 = markdown.links.img.call(null,alt,url,state,cljs.core.not_empty.call(null,title));
var new_text = cljs.core.nth.call(null,vec__22039,(0),null);
var new_state = cljs.core.nth.call(null,vec__22039,(1),null);
...
return cljs.core.first.call(null,cljs.core.reduce.call(null,(function (p1__22041_SHARP_,p2__22040_SHARP_){
return cljs.core.apply.call(null,p2__22040_SHARP_,p1__22041_SHARP_);
}),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [title,state], null),new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [markdown.common.italics,markdown.common.em,markdown.common.strong,markdown.common.bold,markdown.common.strikethrough], null)));
});
markdown.links.make_link = (function markdown$links$make_link(img_QMARK_){
return (function markdown$links$make_link_$_link(text,p__22063){
var map__22074 = p__22063;
...
var state = map__22074__$1;
var code = cljs.core.get.call(null,map__22074__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var codeblock = cljs.core.get.call(null,map__22074__$1,new cljs.core.Keyword(null,"codeblock","codeblock",-851153855));
...
var vec__22076 = cljs.core.split_with.call(null,cljs.core.partial.call(null,cljs.core.not_EQ_,"["),tokens);
var head = cljs.core.nth.call(null,vec__22076,(0),null);
var xs = cljs.core.nth.call(null,vec__22076,(1),null);
var vec__22077 = markdown.links.handle_img_link.call(null,xs,loop_state);
var xs__$1 = cljs.core.nth.call(null,vec__22077,(0),null);
var loop_state__$1 = cljs.core.nth.call(null,vec__22077,(1),null);
var vec__22078 = cljs.core.split_with.call(null,cljs.core.partial.call(null,cljs.core.not_EQ_,"]"),xs__$1);
var title = cljs.core.nth.call(null,vec__22078,(0),null);
var ys = cljs.core.nth.call(null,vec__22078,(1),null);
var vec__22079 = cljs.core.split_with.call(null,cljs.core.partial.call(null,cljs.core.not_EQ_,"("),ys);
var dud = cljs.core.nth.call(null,vec__22079,(0),null);
var zs = cljs.core.nth.call(null,vec__22079,(1),null);
var vec__22080 = cljs.core.split_with.call(null,cljs.core.partial.call(null,cljs.core.not_EQ_,")"),zs);
var link__$1 = cljs.core.nth.call(null,vec__22080,(0),null);
var tail = cljs.core.nth.call(null,vec__22080,(1),null);
if(((cljs.core.count.call(null,link__$1) < (2))) || ((cljs.core.count.call(null,tail) < (1))) || ((cljs.core.count.call(null,dud) > (1)))){
var G__22084 = cljs.core.concat.call(null,out,head,markdown.links.process_link_title.call(null,title,state),dud,link__$1);
var G__22085 = tail;
var G__22086 = loop_state__$1;
out = G__22084;
tokens = G__22085;
loop_state = G__22086;
continue;
...
var vec__22081 = markdown.links.href.call(null,cljs.core.rest.call(null,markdown.links.process_link_title.call(null,title,state)),cljs.core.rest.call(null,link__$1),loop_state__$1);
var link_text = cljs.core.nth.call(null,vec__22081,(0),null);
var new_loop_state = cljs.core.nth.call(null,vec__22081,(1),null);
var G__22087 = cljs.core.concat.call(null,out,head,link_text);
var G__22088 = cljs.core.rest.call(null,tail);
var G__22089 = new_loop_state;
out = G__22087;
tokens = G__22088;
loop_state = G__22089;
continue;
...
var vec__22082 = cljs.core.split_with.call(null,cljs.core.partial.call(null,cljs.core.not_EQ_," "),cljs.core.rest.call(null,link__$1));
var url = cljs.core.nth.call(null,vec__22082,(0),null);
var title__$1 = cljs.core.nth.call(null,vec__22082,(1),null);
...
var vec__22083 = markdown.links.img.call(null,alt,url,loop_state__$1,title__$2);
var img_text = cljs.core.nth.call(null,vec__22083,(0),null);
var new_loop_state = cljs.core.nth.call(null,vec__22083,(1),null);
var G__22090 = cljs.core.concat.call(null,cljs.core.butlast.call(null,head),img_text);
var G__22091 = cljs.core.rest.call(null,tail);
var G__22092 = new_loop_state;
out = G__22090;
tokens = G__22091;
loop_state = G__22092;
continue;
...
var vec__22095 = clojure.string.split.call(null,reference,/\]\s*/,(2));
var title = cljs.core.nth.call(null,vec__22095,(0),null);
var id = cljs.core.nth.call(null,vec__22095,(1),null);
var vec__22096 = cljs.core.get.call(null,references,id);
var link = cljs.core.nth.call(null,vec__22096,(0),null);
var alt = cljs.core.nth.call(null,vec__22096,(1),null);
...
return cljs.core.second.call(null,cljs.core.reduce.call(null,(function (p__22099,link){
var vec__22100 = p__22099;
var i__$1 = cljs.core.nth.call(null,vec__22100,(0),null);
var encoded = cljs.core.nth.call(null,vec__22100,(1),null);
...
return cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,(function (p__22103){
...
return (function (s,p__22107){
var vec__22108 = p__22107;
var id = cljs.core.nth.call(null,vec__22108,(0),null);
var link = cljs.core.nth.call(null,vec__22108,(1),null);
...
markdown.links.reference_link = (function markdown$links$reference_link(text,p__22109){
var map__22112 = p__22109;
...
var code = cljs.core.get.call(null,map__22112__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var codeblock = cljs.core.get.call(null,map__22112__$1,new cljs.core.Keyword(null,"codeblock","codeblock",-851153855));
var references = cljs.core.get.call(null,map__22112__$1,new cljs.core.Keyword(null,"references","references",882562509));
...
markdown.links.replace_all_footnote_links = (function markdown$links$replace_all_footnote_links(text,p__22114){
while(true){
...
var footnotes = cljs.core.get.call(null,map__22117__$1,new cljs.core.Keyword(null,"footnotes","footnotes",-1842778205));
...
var G__22119 = next_text;
var G__22120 = next_state;
text = G__22119;
p__22114 = G__22120;
continue;
}
...
markdown.links.footnote_link = (function markdown$links$footnote_link(text,p__22121){
var map__22125 = p__22121;
...
var code = cljs.core.get.call(null,map__22125__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var codeblock = cljs.core.get.call(null,map__22125__$1,new cljs.core.Keyword(null,"codeblock","codeblock",-851153855));
var footnotes = cljs.core.get.call(null,map__22125__$1,new cljs.core.Keyword(null,"footnotes","footnotes",-1842778205));
...
var vec__22127 = markdown.links.replace_all_footnote_links.call(null,text,state);
var text__$1 = cljs.core.nth.call(null,vec__22127,(0),null);
var state__$1 = cljs.core.nth.call(null,vec__22127,(1),null);
...
markdown.links.image_reference_link = (function markdown$links$image_reference_link(text,p__22128){
var map__22132 = p__22128;
...
var references = cljs.core.get.call(null,map__22132__$1,new cljs.core.Keyword(null,"references","references",882562509));
...
var vec__22134 = cljs.core.first.call(null,ms);
var m = cljs.core.nth.call(null,vec__22134,(0),null);
var alt = cljs.core.nth.call(null,vec__22134,(1),null);
var ref = cljs.core.nth.call(null,vec__22134,(2),null);
...
var G__22135 = cljs.core.rest.call(null,ms);
var G__22136 = clojure.string.replace.call(null,new_text,m,im);
ms = G__22135;
new_text = G__22136;
continue;
} else {
