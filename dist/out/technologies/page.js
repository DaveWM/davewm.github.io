...
return cljs.core.remove.call(null,(function (p1__22463_SHARP_){
var G__22465 = new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(filters);
var G__22465__$1 = (((G__22465 == null))?null:G__22465.toLowerCase());
var G__22465__$2 = (((G__22465__$1 == null))?null:new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(p1__22463_SHARP_).toLowerCase().indexOf(G__22465__$1));
var G__22465__$3 = (((G__22465__$2 == null))?null:((0) > G__22465__$2));
return G__22465__$3;
}),cljs.core.filter.call(null,(function (p1__22462_SHARP_){
return cljs.core.apply.call(null,cljs.core._GT_,cljs.core.map.call(null,new cljs.core.Keyword(null,"experience","experience",1091946507),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__22462_SHARP_,filters], null)));
}),cljs.core.filter.call(null,(function (p1__22461_SHARP_){
return (cljs.core.empty_QMARK_.call(null,new cljs.core.Keyword(null,"types","types",590030639).cljs$core$IFn$_invoke$arity$1(filters))) || (cljs.core.contains_QMARK_.call(null,new cljs.core.Keyword(null,"types","types",590030639).cljs$core$IFn$_invoke$arity$1(filters),cljs.core.keyword.call(null,new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(p1__22461_SHARP_))));
}),data)));
});
technologies.page.type_checkbox = (function technologies$page$type_checkbox(p__22467){
var vec__22469 = p__22467;
var key = cljs.core.nth.call(null,vec__22469,(0),null);
var type = cljs.core.nth.call(null,vec__22469,(1),null);
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent_material_ui.core.Checkbox,new cljs.core.PersistentArrayMap(null, 7, [new cljs.core.Keyword(null,"key","key",-1516042587),key,new cljs.core.Keyword(null,"label","label",1718410804),new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(type),new cljs.core.Keyword(null,"defaultChecked","defaultChecked",-834047344),cljs.core.contains_QMARK_.call(null,new cljs.core.Keyword(null,"types","types",590030639).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,technologies.page.filters_atom)),key),new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"max-width","max-width",-1939924051),(200),new cljs.core.Keyword(null,"display","display",242065432),"inline-block"], null),new cljs.core.Keyword(null,"iconStyle","iconStyle",1185883564),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"fill","fill",883462889),new cljs.core.Keyword(null,"colour","colour",2137094554).cljs$core$IFn$_invoke$arity$1(type)], null),new cljs.core.Keyword(null,"labelStyle","labelStyle",-1942994391),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"color","color",1011675173),new cljs.core.Keyword(null,"colour","colour",2137094554).cljs$core$IFn$_invoke$arity$1(type)], null),new cljs.core.Keyword(null,"onCheck","onCheck",-490696156),((function (vec__22469,key,type){
return (function (event){
return cljs.core.swap_BANG_.call(null,technologies.page.filters_atom,((function (vec__22469,key,type){
return (function (p1__22466_SHARP_){
var checked = event.target.checked;
var operation = (cljs.core.truth_(checked)?clojure.set.union:cljs.core.remove);
return cljs.core.update.call(null,p1__22466_SHARP_,new cljs.core.Keyword(null,"types","types",590030639),((function (checked,operation,vec__22469,key,type){
...
});})(checked,operation,vec__22469,key,type))
);
});})(vec__22469,key,type))
);
});})(vec__22469,key,type))
...
technologies.page.page = (function technologies$page$page(p__22472){
var map__22479 = p__22472;
var map__22479__$1 = ((((!((map__22479 == null)))?((((map__22479.cljs$lang$protocol_mask$partition0$ & (64))) || (map__22479.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__22479):map__22479);
var technologies__$1 = cljs.core.get.call(null,map__22479__$1,new cljs.core.Keyword(null,"technologies","technologies",2141321343));
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.row.middle-xs","div.row.middle-xs",132651383),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"col-xs-12 card-container"], null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"col-xs-12"], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent_material_ui.core.Card,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent_material_ui.core.CardHeader,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"title","title",636505583),"Filters",new cljs.core.Keyword(null,"avatar","avatar",-1607499307),reagent.core.as_element.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent_material_ui.core.Avatar,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"icon","icon",1679606541),reagent.core.as_element.call(null,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent_material_ui.core.FontIcon,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"className","className",-1983287057),"material-icons"], null),"filter_list"], null))], null)], null)),new cljs.core.Keyword(null,"actAsExpander","actAsExpander",-1502963333),true,new cljs.core.Keyword(null,"showExpandableButton","showExpandableButton",-1459489058),true], null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent_material_ui.core.CardText,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"expandable","expandable",-704609097),true], null),new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"row"], null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"col-sm-6"], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"p","p",151049309),"Types"], null),cljs.core.map.call(null,technologies.page.type_checkbox,technologies.page.type_data)], null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"col-sm-3"], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"p","p",151049309),"Experience"], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent_material_ui.core.Slider,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"defaultValue","defaultValue",-586131910),new cljs.core.Keyword(null,"experience","experience",1091946507).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,technologies.page.filters_atom)),new cljs.core.Keyword(null,"min","min",444991522),(0),new cljs.core.Keyword(null,"max","max",61366548),cljs.core.apply.call(null,cljs.core.max,cljs.core.map.call(null,new cljs.core.Keyword(null,"experience","experience",1091946507),technologies__$1)),new cljs.core.Keyword(null,"onChange","onChange",-312891301),((function (map__22479,map__22479__$1,technologies__$1){
return (function (event,value){
cljs.core.print.call(null,value);

return cljs.core.swap_BANG_.call(null,technologies.page.filters_atom,((function (map__22479,map__22479__$1,technologies__$1){
return (function (p1__22470_SHARP_){
return cljs.core.assoc.call(null,p1__22470_SHARP_,new cljs.core.Keyword(null,"experience","experience",1091946507),value);
});})(map__22479,map__22479__$1,technologies__$1))
);
});})(map__22479,map__22479__$1,technologies__$1))
], null)], null)], null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"col-sm-3"], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"p","p",151049309),"Name"], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent_material_ui.core.TextField,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"defaultValue","defaultValue",-586131910),new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,technologies.page.filters_atom)),new cljs.core.Keyword(null,"onChange","onChange",-312891301),((function (map__22479,map__22479__$1,technologies__$1){
return (function (event){
return cljs.core.swap_BANG_.call(null,technologies.page.filters_atom,((function (map__22479,map__22479__$1,technologies__$1){
return (function (p1__22471_SHARP_){
return cljs.core.assoc.call(null,p1__22471_SHARP_,new cljs.core.Keyword(null,"name","name",1843675177),event.target.value);
});})(map__22479,map__22479__$1,technologies__$1))
);
});})(map__22479,map__22479__$1,technologies__$1))
...
var colours_map = cljs.core.reduce.call(null,((function (filtered_data,map__22479,map__22479__$1,technologies__$1){
return (function (result,p__22481){
var vec__22482 = p__22481;
var type = cljs.core.nth.call(null,vec__22482,(0),null);
var val = cljs.core.nth.call(null,vec__22482,(1),null);
...
});})(filtered_data,map__22479,map__22479__$1,technologies__$1))
,cljs.core.PersistentArrayMap.EMPTY,technologies.page.type_data);
var chart_colour_key = cljs.core.reduce.call(null,((function (filtered_data,colours_map,map__22479,map__22479__$1,technologies__$1){
return (function (result,p__22483){
var vec__22484 = p__22483;
var type = cljs.core.nth.call(null,vec__22484,(0),null);
var props = cljs.core.nth.call(null,vec__22484,(1),null);
...
});})(filtered_data,colours_map,map__22479,map__22479__$1,technologies__$1))
